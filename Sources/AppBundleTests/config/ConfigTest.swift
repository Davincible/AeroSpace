        ...
        assertEquals(
            ...
            Gaps(
                inner: .init(
                    vertical: .perMonitor(
                        [
                            PerMonitorValue(description: .main, value: .pixels(1), windows: nil, workspace: nil),
                            PerMonitorValue(description: .secondary, value: .pixels(2), windows: nil, workspace: nil),
                        ],
                        default: .pixels(5),
                    ),
                ...
                outer: .init(
                    ...
                    top: .perMonitor(
                        [
                            PerMonitorValue(description: .caseSensitivePattern("built-in")!, value: .pixels(3), windows: nil, workspace: nil),
                            PerMonitorValue(description: .secondary, value: .pixels(4), windows: nil, workspace: nil),
                        ],
                        default: .pixels(6),
                    ),
                    right: .perMonitor([PerMonitorValue(description: .sequenceNumber(2), value: .pixels(7), windows: nil, workspace: nil)], default: .pixels(8)),
                ),
            ),
        )
        ...
        assertEquals(
            ...
            Gaps(
                inner: .init(
                    vertical: .perMonitor(
                        [
                            PerMonitorValue(description: .main, value: .percentage(10), windows: nil, workspace: nil),
                            PerMonitorValue(description: .secondary, value: .pixels(20), windows: nil, workspace: nil),
                        ],
                ...
                outer: .init(
                    ...
                    top: .perMonitor(
                        [PerMonitorValue(description: .caseSensitivePattern("built-in")!, value: .percentage(1), windows: nil, workspace: nil)],
                        default: .pixels(10),
                    ),
